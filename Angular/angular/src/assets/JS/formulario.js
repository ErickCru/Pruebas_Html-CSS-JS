...
/* Objeto de los métodos del formulario */
...
var mf = {
    ...
    enFoco: function(input){
        ...
        if(pf.valor == ""){
            ...
            document.querySelector("#"+input.target.id).style.background = "rgba(15,150,120,.5)";
    ...
    validarFormulario: function(){
        ...
        if(!pf.validarUsuario || !pf.validarEmail || !pf.validarPassword){
